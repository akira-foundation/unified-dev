            ...
            <ul className="space-y-2 mb-4">
              {currentPlan === "free" && (
                <>
                  ...
                  <li className="flex items-center gap-2 text-[13px] text-zinc-600 dark:text-zinc-400">
                    <span className="text-zinc-500">–</span> {t("settings.general.account.plan.limit.repos")}
                  </li>
                  <li className="flex items-center gap-2 text-[13px] text-zinc-600 dark:text-zinc-400">
                    <span className="text-zinc-500">–</span> {t("settings.general.account.plan.limit.orgs")}
                  </li>
                  <li className="flex items-center gap-2 text-[13px] text-zinc-600 dark:text-zinc-400">
