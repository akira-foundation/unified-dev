  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <div className="space-y-1">
            ...
            <CardDescription className="text-[10px] font-bold uppercase tracking-widest text-zinc-500/80">
              Total: {TEAM_MEMBERS.length} membros ativos
            </CardDescription>
          </div>

          <Dialog open={isAddModalOpen} onOpenChange={setIsAddModalOpen}>
            <DialogTrigger asChild>
              <Button size="icon" className="h-10 w-10 rounded-full bg-purple-600 hover:bg-purple-700 text-white shadow-lg shadow-purple-600/20 dark:bg-zinc-100 dark:text-purple-700 dark:hover:bg-white transition-all active:scale-95">
            ...
            <DialogContent className="sm:max-w-[425px]">
              ...
              <div className="grid gap-4 py-4">
                <div className="grid gap-2">
                  ...
                  <Input id="name" placeholder="Ex: Ana Silva" className="rounded-xl" />
                </div>
                <div className="grid gap-2">
                  <Label htmlFor="email">Email Profissional</Label>
                  <Input id="email" placeholder="nome@akira.app" type="email" className="rounded-xl" />
                </div>
                <div className="grid gap-2">
              ...
              <DialogFooter>
                ...
                <Button onClick={() => setIsAddModalOpen(false)} className="bg-purple-600 hover:bg-purple-700 text-white dark:bg-white dark:text-purple-700 dark:hover:bg-zinc-100 rounded-xl">
                  Adicionar Membro
                </Button>
              </DialogFooter>
            </DialogContent>
        ...
        {totalPages > 1 && (
          <div className="flex items-center justify-between border-t border-zinc-100 p-4 dark:border-zinc-800/50">
            <Button
              variant="outline"
              size="sm"
