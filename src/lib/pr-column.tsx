import { Circle, CircleDot, GitMerge } from "lucide-react";

import { cn } from "@/lib/utils";
import type { PullRequestDto } from "@/types/organization";

export type PrColumnId = "todo" | "inprogress" | "review" | "done";

export const PR_COLUMN_ORDER: PrColumnId[] = ["todo", "inprogress", "review", "done"];
