...
SELECT id, name, description, enabled, icon_path, installed_at, source_path, scope, customer_id FROM skills;
DROP TABLE skills;
...
SELECT id, name, url, access_token, token_type, enabled, created_at, customer_id FROM mcp_servers;
