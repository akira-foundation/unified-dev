...
#[tauri::command]
pub async fn create_thread_with_title(
    repo_id: String,
    title: String,
...
#[tauri::command]
pub async fn create_thread_from_branch(
    repo_id: String,
    title: String,
...
#[tauri::command]
pub async fn create_thread_from_pull_request(
    repo_id: String,
    title: String,
    head_sha: String,
    state: State<'_, AppState>,
...
pub async fn rename_thread(
    ...
    new_name: String,
    state: State<'_, AppState>,
) -> AppResult<crate::app::threads::ThreadRow> {
...
pub async fn update_repository_settings(
    ...
    threads::update_repo_settings::update(
        &repo_id,
        display_name,
        clear_display_name,
        default_branch,
        default_model_id,
        clear_default_model_id,
        review_model_id,
        clear_review_model_id,
        default_merge_action,
        clear_default_merge_action,
        &state.pool().await?,
    )
    .await
}
...
#[tauri::command]
pub async fn get_repo_provider_login(
    repo_id: String,
    state: State<'_, AppState>,
...
#[tauri::command]
pub async fn list_thread_source_issues(
    repo_id: String,
    state: State<'_, AppState>,
...
#[tauri::command]
pub async fn list_thread_source_pull_requests(
    repo_id: String,
    state: State<'_, AppState>,
) -> AppResult<Vec<PullRequestDto>> {
    threads::source_picker::list_pull_requests(repo_id, state).await
}

#[tauri::command]
pub async fn list_thread_source_branches(
    repo_id: String,
    state: State<'_, AppState>,
