...
use crate::db::inputs::CreateOrganizationInput;
use crate::db::models::OrganizationRecord;
use crate::db::models::OrganizationSummary;
use crate::support::error::AppError;
use crate::state::AppState;

pub async fn create(state: State<'_, AppState>, input: CreateOrganizationInput) -> Result<OrganizationSummary, String> {
